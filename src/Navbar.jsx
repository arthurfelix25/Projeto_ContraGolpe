...
function Navbar() {
    return(
    <nav className="bg-[#f2f2f2] text-[#00008B] border-b-[1px] border-b-[#d2d2d2] flex justify-between items-center gap-8 py-0 px-4 font-bold text-[22px]">
            ...
            <ul className="m-0 p-0 list-none flex gap-4">
                ...
                <li>
                    <Link to="/rempresas" className="rounded-md bg-[#0b3d91] px-3 py-1.5 text-white font-semibold text-sm hover:bg-[#0e56bd]">Login Empresa</Link>
                </li>
            </ul>
        </nav>
    )
